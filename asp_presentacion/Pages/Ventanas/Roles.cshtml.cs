    ...
    public class RolesModel : PageModel
    {
        ...
        public virtual void OnPostBtGuardar()
        {
            try
            {
                ...
                if (Actual!.Id == 0)
                {
                    ...
                    GuardarAuditoria("Gua", "Guardar", "Roles", Actual.Nombre, IndexModel.UsuarioGlobal, DateTime.Now);

                }
                else
                {
                    task = this.iPresentacion!.Modificar(Actual!)!;
                    GuardarAuditoria("Mod", "Modificar", "Roles", Actual.Nombre, IndexModel.UsuarioGlobal, DateTime.Now);
                }
                task.Wait();
                Actual = task.Result;
                Accion = Enumerables.Ventanas.Listas;
        ...
        public virtual void OnPostBtBorrar()
        {
            try
            {
                ...
                GuardarAuditoria("Bor", "Borrar", "Roles", Actual.Nombre, IndexModel.UsuarioGlobal, DateTime.Now);
